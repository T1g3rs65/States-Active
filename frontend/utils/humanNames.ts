/** Large human name pools for the leader screen. Austin is in the male pool but not default. No Sigears. */
...
export const FEMALE_FIRST = [
  ...
  'Edith', 'Fiona', 'Gwendolyn', 'Honora', 'Ingrid',
];
