...
def get_government_description(gov_type: GovernmentType) -> str:
    ...
    descriptions = {
        ...
        GovernmentType.LEFT_WING_UTOPIA: "A socialist paradise where equality reigns supreme.",
        GovernmentType.SCANDINAVIAN_PARADISE: "A balanced welfare state with high quality of life.",
        GovernmentType.DEMOCRATIC_SOCIALISTS: "Democracy with strong social safety nets.",
        GovernmentType.LIBERAL_DEMOCRACY: "Freedom and opportunity in perfect harmony.",
        GovernmentType.CAPITALIST_PARADISE: "Free markets drive prosperity for all.",
        GovernmentType.CORPORATE_POLICE_STATE: "Corporations rule with an iron fist.",
        GovernmentType.RIGHT_WING_UTOPIA: "Minimal government, maximum freedom.",
        GovernmentType.AUTHORITARIAN_DEMOCRACY: "Order maintained through strong leadership.",
        GovernmentType.BENEVOLENT_DICTATORSHIP: "A wise leader guides the nation.",
        GovernmentType.IRON_FIST_CONSUMERISTS: "Buy what you want, say what you're told.",
        GovernmentType.MORALISTIC_DEMOCRACY: "Traditional values enforced democratically.",
        GovernmentType.PSYCHOTIC_DICTATORSHIP: "Fear and oppression define daily life.",
        GovernmentType.ANARCHY: "Chaos reigns in the absence of order.",
        GovernmentType.FATHER_KNOWS_BEST_STATE: "The government knows what's best for you.",
        GovernmentType.ECO_SOCIALIST_HAVEN: "Environmental harmony through collective action.",
        GovernmentType.WELFARE_PARADISE: "The state provides for all its citizens.",
        GovernmentType.LAISSEZ_FAIRE_DYNAMO: "Pure capitalism unleashed.",
        GovernmentType.TECH_OLIGARCHY: "The technological elite lead the way forward.",
        GovernmentType.TRADE_EMPIRE: "Commerce is king, trade flows freely.",
        GovernmentType.SURVEILLANCE_PANOPTICON: "All is watched, all is known.",
        GovernmentType.THEOCRATIC_ENFORCERS: "Divine law guides every action.",
        GovernmentType.MARTIAL_COMMAND: "Military discipline brings order.",
        GovernmentType.SEASTEAD_REPUBLIC: "Freedom floats on international waters.",
        GovernmentType.PSYCHEDELIC_FREE_STATE: "Expand your mind, expand your rights.",
        GovernmentType.PRAGMATIC_MERITOCRACY: "The skilled rise to lead.",
        GovernmentType.TECHNOCRATIC_SYNDICATE: "Experts guide the nation rationally.",
        GovernmentType.INOFFENSIVE_CENTRIST_DEMOCRACY: "A balanced, moderate democracy.",
        GovernmentType.CIVIL_RIGHTS_LOVEFEST: "Personal freedom above all else.",
        GovernmentType.CORPORATE_BORDELLO: "Anything can be bought, for a price.",
        GovernmentType.CORRUPT_DICTATORSHIP: "Graft and greed at the highest levels.",
        GovernmentType.FREE_MARKET_PARADISE: "The invisible hand guides prosperity.",
        GovernmentType.CYBERPUNK_MEGACITY: "High tech, low life.",
        GovernmentType.PIRATE_HAVEN: "Freedom and lawlessness on the high seas.",
        GovernmentType.SOCIALIST_REPUBLIC: "The state controls the economy for the common good.",
        GovernmentType.PEOPLES_REPUBLIC: "The party guides all aspects of society.",
        
        # Zythera Hive Government Types
        GovernmentType.COLLECTIVE_HIVE: "The Queen ensures all workers share equally in the hive's bounty.",
        GovernmentType.WORKERS_SWARM: "Every Zythera labors together, equals under the benevolent Queen.",
        GovernmentType.ROYAL_HIVE: "The Queen's word is absolute law, hierarchy is sacred.",
        GovernmentType.IMPERIAL_SWARM: "The swarm expands ever outward under the conquering Queen.",
        GovernmentType.DIVINE_HIVE: "The Queen is worshipped as a living goddess.",
        GovernmentType.MILITANT_HIVE: "Warriors of the hive stand ready at the Queen's command.",
        GovernmentType.ORDERED_COLONY: "Efficient bureaucracy serves the Queen's vision.",
        GovernmentType.SYMBIOTIC_SWARM: "Individual Zythera flourish in cooperative harmony.",
        GovernmentType.NURTURING_HIVE: "The Queen tends to her children with loving care.",
        GovernmentType.MERCHANT_HIVE: "Trade and commerce bring wealth to the swarm.",
        GovernmentType.TECHNO_SWARM: "Innovation drives the hive forward under a progressive Queen.",
        GovernmentType.HARMONIOUS_HIVE: "Balance and peace define this well-ordered colony.",
        GovernmentType.FREE_COLONY: "The Queen grants maximum autonomy to her subjects.",
        GovernmentType.BALANCED_HIVE: "Pragmatic governance serves the hive's needs.",
        GovernmentType.DIPLOMATIC_SWARM: "The Queen seeks friendship with other species.",
        GovernmentType.PARASITIC_HIVE: "The swarm takes what it needs from others.",
